...
* Update dependency @balena/compose to v7 [balena-renovate[bot]]

## 2.0.12 - 2025-09-30

* Remove support for Node <20 [Christina Ying Wang]
* Bump tar-fs to 3.1.1 [Christina Ying Wang]

## 2.0.11 - 2025-02-28

* Stringify `cachefrom` option passed to the builder [Felipe Lalanne]

## 2.0.10 - 2025-02-05

* Update dependency typedoc to ^0.27.0 [balena-renovate[bot]]

## 2.0.9 - 2025-01-27

* Fix architecture detection for arm64 [Felipe Lalanne]
